...
- [ ] `parcial` variacoes de falas secundarias de NPCs de Pallet
...
- [ ] `parcial` subcenas de deslocamento entre areas da floresta
...
- [ ] `parcial` detalhamento dialogado da transicao pre e pos batalha de Brock
...
- [ ] `parcial` subeventos de navegação interna na caverna
...
- [ ] `parcial` cenas de interacao local com NPCs de cidade
...
- [ ] `parcial` detalhamento de transicoes entre porto/navio/cidade
...
- [ ] `parcial` subcenas internas de torre/andares
...
- [ ] `parcial` cenas curtas de consequencia por personagem secundario
...
- [ ] `parcial` microcenas de descoberta de documentos/artefatos

## Capitulo 10 - Viridian Gym e Giovanni
- [x] `coberto` confronto direto com Giovanni -> `ch13_viridian_giovanni`
- [ ] `parcial` preambulo dialogado mais longo de rivalidade/ideologia
...
- [ ] Substituir todos os itens `parcial` por `coberto`.
- [ ] Preencher `sourceRef` por beat com capitulo/pagina concretos.
- [ ] Revisar dialogos beat a beat contra a referencia e marcar diff de fidelidade.
